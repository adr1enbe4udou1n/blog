...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ------------------------ |
| [Laravel 12](https://github.com/adr1enbe4udou1n/laravel-realworld-example-app) ([api](https://laravelrealworld.okami101.io/api/) / [image](https://gitea.okamii101.io/conduit/-/packages/container/laravel/latest))                 | FrankenPHP 8.4        | Eloquent                 |
| [Symfony 7.2](https://github.com/adr1enbe4udou1n/symfony-realworld-example-app) ([api](https://symfonyrealworld.okami101.io/api/) / [image](https://gitea.okamii101.io/conduit/-/packages/container/symfony/latest))                | FrankenPHP 8.4        | Doctrine                 |
| [FastAPI](https://github.com/adr1enbe4udou1n/fastapi-realworld-example-app) ([api](https://fastapirealworld.okami101.io/api/) / [image](https://gitea.okamii101.io/conduit/-/packages/container/fastapi/latest))                    | Python 3.13 (asyncio) | SQLAlchemy 2.0 (asyncio) |
| [NestJS 11](https://github.com/adr1enbe4udou1n/nestjs-realworld-example-app) ([api](https://nestjsrealworld.okami101.io/api/) / [image](https://gitea.okamii101.io/conduit/-/packages/container/nestjs/latest))                     | Node 22               | Prisma 6                 |
| [Spring Boot 3.4](https://github.com/adr1enbe4udou1n/spring-boot-realworld-example-app) ([api](https://springbootrealworld.okami101.io/api/) / [image](https://gitea.okamii101.io/conduit/-/packages/container/spring-boot/latest)) | Java 21               | Hibernate 6              |
| [ASP.NET Core 9](https://github.com/adr1enbe4udou1n/aspnetcore-realworld-example-app) ([api](https://aspnetcorerealworld.okami101.io/api/) / [image](https://gitea.okamii101.io/conduit/-/packages/container/aspnet-core/latest))   | .NET 9.0              | EF Core 9                |
...
services:
  app:
    image: gitea.okamii101.io/conduit/laravel:latest
    environment:
...
services:
  app:
    image: gitea.okamii101.io/conduit/symfony:latest
    environment:
...
services:
  app:
    image: gitea.okamii101.io/conduit/fastapi:latest
    environment:
      - DB_HOST=postgres_db
...
services:
  app:
    image: gitea.okamii101.io/conduit/nestjs:latest
    environment:
      - NODE_ENV=production
...
services:
  app:
    image: gitea.okamii101.io/conduit/spring-boot:latest
    environment:
